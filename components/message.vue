...
.ico-message {
  ...
  width: 14px;
  height: 14px;
  background-image: url(~@/assets/img/msg/icon_tis.png);
...
.ico-delete {
  ...
  width: 18px;
  height: 18px;
  background-image: url(~@/assets/img/msg/icon_fail@3x.png);
  background-size: contain;
  background-repeat: no-repeat;
  vertical-align: text-top;
}
.ico-success {
  ...
  line-height: 13px;
  font-size: rem1(40);
  // background-image: url(../assets/img/msg/icon_chengg.png);
  // background-size: 100%;
  background-repeat: no-repeat;
  vertical-align: text-top;
}
.icon-loading {
  ...
  width: 18px;
  height: 18px;
  background-image: url(~@/assets/img/msg/icon_loading@3x.png);
  background-size: contain;
  background-repeat: no-repeat;
  vertical-align: text-top;
}
